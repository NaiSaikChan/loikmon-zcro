...
class ArticlesReviews extends StatefulWidget {
  static const routeName = "/ArticlesReviews";
  ArticlesReviews(this.books);
...
class _EbookReviewsState extends State<ArticlesReviews> {
  @override
  Widget build(BuildContext context) {
    AppStateManager appStateManager = Provider.of<AppStateManager>(context);
    return ChangeNotifierProvider(
        create: (context) => CommentsModel(context, widget.books!.id!, 1, true),
        child: ListView(
          shrinkWrap: true,
                  ...
                  children: <Widget>[
                    ...
                    Visibility(
                      ...
                      child: MaterialButton(
                        elevation: 0,
                        textColor: const Color.fromARGB(255, 242, 240, 240),
                        color: MyColors.mainC0lor,
                        height: 0,
                        ...
                        onPressed: () {
                          Navigator.of(context).pushNamed(
                              ArticlesReviewsScreen.routeName,
