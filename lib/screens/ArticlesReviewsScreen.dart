...
class ArticlesReviewsScreen extends StatefulWidget {
  static const routeName = "/ArticlesReviewsScreen";
  ArticlesReviewsScreen(this.books);
  final Articles? books;

  @override
  State<ArticlesReviewsScreen> createState() => _ReviewsScreenState();
}

class _ReviewsScreenState extends State<ArticlesReviewsScreen> {
  @override
  Widget build(BuildContext context) {
    AppStateManager appStateManager = Provider.of<AppStateManager>(context);
    return ChangeNotifierProvider(
      create: (context) => CommentsModel(context, widget.books!.id!, 1, false),
      child: Scaffold(
        appBar: AppBar(
          toolbarHeight: 50,
          title: Text(
