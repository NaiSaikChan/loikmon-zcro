...
import 'package:loikmon/providers/LeaguesModel.dart';
...
class LeaguesScreen extends StatelessWidget {
  static const routeName = "/LeaguesScreen";
  LeaguesScreen();

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => LeaguesModel(0),
      child: Container(
...
class _CategoriesMediaScreenState extends State<CategoryScreen> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 0), () {
      Provider.of<LeaguesModel>(context, listen: false).loadItems(query);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    authorsModel = Provider.of<LeaguesModel>(context);
